...
#define LIBNAME          "spssxd.dll"
#else
	#define LIBHANDLE        void*
	#define GETADDRESS       dlsym
	#ifdef HPUX
	#define LIBNAME			 "libspssxd.sl"
	#else
		#ifdef DARWIN
		#define LIBNAME			 "libspssxd.dylib"
		#else
		#define LIBNAME          "libspssxd.so"
		#endif
	#endif
#endif
...
void filelist(std::vector<std::string>& fList)
{
    ...
    // For example, "c:\\Progra~1\\IBM\\SPSS\\Statistics\\samples\\" for win32
