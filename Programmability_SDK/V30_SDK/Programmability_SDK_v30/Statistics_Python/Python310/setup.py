...
if sys.platform == 'win32':
    ...
    if os.uname()[2].split('.')[0] == '18':
        os.environ['CC'] = 'clang'
        os.environ['CXX'] = 'clang++'
        os.environ['CFLAGS'] = '-std=c++11 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk -mmacosx-version-min=10.12 -fno-strict-aliasing -fno-common -dynamic'
        os.environ['LINKCC'] = os.environ['CC']
        os.environ['LDSHARED'] = '-g -bundle -undefined dynamic_lookup'
        EXTRA_LINK_ARGS = ['-lstdc++', '-std=c++11', '-Wl,-syslibroot,/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk -mmacosx-version-min=10.12']
    else:
        os.environ['CC'] = 'gcc'
        os.environ['CXX'] = 'gcc'
        os.environ['LINKCC'] = os.environ['CC']
    ...
    LIBRARY_DIRS = [ os.environ['PYTHON_HOME']+'/lib']
...
def setup_package():
    ...
    try:
        ...
        if sys.platform == 'win32':
            ...
            package_macros = [('__PYTHON3__', None),('__MACOSX__', None)]
        elif sys.platform == 'sunos5':
            package_macros = [('__PYTHON3__', None),('__UNX_SUNOS__', None)]
        elif sys.platform == 'aix6' or sys.platform == 'aix7':
            package_macros = [('__PYTHON3__', None)]
        elif sys.platform.lower().find('linux') > -1 :
            package_macros = [('__PYTHON3__', None),('__UNX_LINUX__', None)]
        elif sys.platform == 'hp-ux11':
            package_macros = [('__PYTHON3__', None),('__HPUX64__', None)]
        else :
            package_macros = []
