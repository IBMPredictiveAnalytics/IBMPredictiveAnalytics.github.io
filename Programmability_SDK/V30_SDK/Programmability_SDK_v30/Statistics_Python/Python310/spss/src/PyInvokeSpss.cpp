...
extern "C"{
   ...
   {"GetDataFileAttributeNamesInProcDS", ext_GetDataFileAttributeNamesInProcDS, METH_VARARGS,
    ...
    static FP_GetXmlUtf16Length GetXmlUtf16Length = NULL;
  ...
  void InitializeFP()
  {
    ...
    GetXmlUtf16Length = (FP_GetXmlUtf16Length)GETADDRESS(pLib,"GetXmlUtf16Length");
  ...
  int LoadLib()
  {
    ...
    if(NULL == pLib) {
         ...
         LIBHANDLE pLib1 = NULL;
         LIBHANDLE pLib2 = NULL;
         LIBHANDLE pLib3 = NULL;
...
//========================================================================
  ...
  ext_StartSpss(PyObject *self, PyObject *args)
  {
    ...
    // const char* language = "-language=python3,";
    ...
    //   SetXNameAndSHome("PYTHON3",getenv("SPSS_HOME"));
  ...
  ext_GetXmlUtf16(PyObject *self, PyObject *args)
  {
    ...
    int length = GetXmlUtf16Length() * 2;
    char* value = (char*)"";
    if ( length > 0 )
        value = (char*)result;
    else
        length = 0;
    PyObject* pyValue = PyUnicode_DecodeUTF16(value, length, NULL, NULL);
    PyObject* out = Py_BuildValue("Oi",pyValue,errLevel);
    Py_XDECREF(pyValue);
    return out;
  }
  ...
  ext_GetImage(PyObject *self, PyObject *args)
  {
      ...
      PyObject* out = Py_BuildValue("y#isi",result,imageSize,imageSize,imageType,errLevel);
      return out;
  }
    ...
    ext_SetVarValueStringCell(PyObject *self, PyObject *args)
{
  ...
  typedef struct {
    ...
    int  MakeConverter(SPSS_ResultObject *resultSet, PyObject *conv) {
        ...
        for(i = 0; i < varCount; ++i) {
            ...
            tmp = PyLong_FromLong((long)formatType);
            if(!tmp) {
    ...
    ext_cursor(PyObject *self, PyObject *args) {
        ...
        int len = 0;
        char * accessType;
        PyObject *conv = NULL, *varTuple = NULL;
  ...
  PyTypeObject SPSS_ResultObject_Type = {
        ...
        for(Py_ssize_t k = 0; k < caseNumber; k++)
        {
            ...
            for(int j = 0; j < typeSize; j++)
            {
                ...
                else
                {
                    ...
                    memcpy(tmpData,c,(int)strlen(c)>newVarType[j]?newVarType[j]:strlen(c));
	...
	static PyModuleDef PyInvokeSpssmodule = {
		PyModuleDef_HEAD_INIT,
		"PyInvokeSpss",
		NULL,
		-1,
		PyInvokeSpss_methods
	};

    PyMODINIT_FUNC
    PyInit_PyInvokeSpss(void)
    {
		PyObject *module;
        //Py_InitModule("PyInvokeSpss", PyInvokeSpss_methods);
		module = PyModule_Create(&PyInvokeSpssmodule);
        LoadLib();
        ...
        SPSS_ResultObject_Type.tp_free = PyObject_GC_Del;
