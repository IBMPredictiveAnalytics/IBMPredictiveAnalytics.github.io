...
typedef int             (*FP_MoveVariables)(const char* dsName,
                                            int varIndexes[],
                                            const int keepCount,
                                            const int targetIndex);
typedef int             (*FP_IsUseOrFilter)(int &isUse);
typedef int             (*FP_CreateSocket)(int &port);
typedef int             (*FP_AcceptSocket)();

typedef int*            (*FP_GetTrendsInfoInDS)(const char* dsName,
                                               int& size, 
                                               int& errCode);
typedef long            (*FP_GetSelectedRowCountInProcDS)(int& errCode);
   /**
    ...
    */
    ...
    PYINVOKESPSS_API PyObject * ext_GetImage( PyObject *self,
      ...
      *                                   are the names of the SET subcommands,  in upper case for example, 
      ...
      *                             any of those four keywords to obtain the associated value of the keyword Yes or  No
    ...
    */
    ...
    PYINVOKESPSS_API PyObject * ext_StartDataStep(
        ...
        PYINVOKESPSS_API PyObject * ext_IsUseOrFilter(
                                                        PyObject *self,
                                                        PyObject *args);
        PYINVOKESPSS_API PyObject * ext_MoveVariables(
                                                        PyObject *self,
                                                        PyObject *args);
                                                        
        PYINVOKESPSS_API PyObject * ext_CreateSocket(
                                                        PyObject *self,
                                                        PyObject *args);
        PYINVOKESPSS_API PyObject * ext_AcceptSocket(
                                                        PyObject *self,
                                                        PyObject *args);
        PYINVOKESPSS_API PyObject * ext_GetTrendsInfoInDS(
                                                        PyObject *self,
                                                        PyObject *args);
        PYINVOKESPSS_API PyObject * ext_GetSelectedRowCountInProcDS(
                                                        PyObject *self,
                                                        PyObject *args);
